<template>
  <el-drawer v-model="drawerVisible" :destroy-on-close="true" size="450px" :title="`${drawerProps.title}客户`">
    <el-form
      ref="ruleFormRef"
      label-width="100px"
      label-suffix=" :"
    ...
    >
      ...
      <el-form-item label="客户照片" prop="photo">
      ...
      <el-form-item label="客户姓名" prop="username">
        <el-input v-model="drawerProps.row!.username" placeholder="请填写客户姓名" clearable></el-input>
      </el-form-item>
...
const rules = reactive({
  ...
  photo: [{ required: true, message: "请上传客户照片" }],
  username: [{ required: true, message: "请填写客户姓名" }],

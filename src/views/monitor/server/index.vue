          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%">
              ...
              <tbody>
                ...
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">客户使用率</div></td>
                  <td class="el-table__cell is-leaf">
      ...
      <el-col :span="12" class="card-box">
        <el-card>
          <template #header>
            <div>
              <span
                ><el-icon><Tickets /></el-icon> 内存</span
              >
            </div>
          </template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
      ...
      <el-col :span="24" class="card-box">
        <el-card>
          <template #header>
            <div>
              <span
                ><el-icon><Monitor /></el-icon> 服务器信息</span
              >
            </div>
          </template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
      ...
      <el-col :span="24" class="card-box">
        <el-card>
          <template #header>
            <div>
              <span
                ><el-icon><Coffee /></el-icon> Java虚拟机信息</span
              >
            </div>
          </template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
...
<script>
import { getServer } from "@/api/modules/monitor/server";
import { Cpu, Tickets, Monitor, Coffee, Box } from "@element-plus/icons-vue";

...
import { filterEnum, formatValue, handleProp, handleRowAccordingToProp, TABLE_EMPTY_PLACEHOLDER } from "@/utils";
        ...
        >
          {{
            default: (scope: RenderScope<any>) => {
              ...
              const cellVal = renderCellData(item, scope);
              if (cellVal === TABLE_EMPTY_PLACEHOLDER) return <span class="table-cell-empty">{cellVal}</span>;
              return cellVal;
            },
